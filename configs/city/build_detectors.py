"""Generate E2 detector .add.xml for all incoming lanes at TL junctions in city.net.xml.

Adapted from configs/grid_4x4/build_detectors.py.
...
NET = sumolib.net.readNet(str(HERE / 'city.net.xml'))
NOMINAL = 200.0
...
xml_str = '\n'.join(xml_str.split('\n')[1:])
out = HERE / 'city.add.xml'
out.write_text('<?xml version="1.0" encoding="UTF-8"?>\n' + xml_str)
print(f'Wrote {n_det} detectors -> {out}')
